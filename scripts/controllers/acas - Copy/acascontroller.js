...
angular.module('GenesisApp')
  .controller('acascontroller', ['$scope', '$http', 'notification', 'acasHttp', 'ngDialog', 'communication', '$rootScope', '$timeout',
    function ($scope, $http, notification, acasHttp, ngDialog, communication, $rootScope, $timeout) {
      $scope.cardips = true;

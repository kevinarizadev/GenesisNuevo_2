    ...
    if($scope.celular != null){
      $http({
        ...
        data: {
          ...
          "to": "57"+$scope.celular,
          "text": "Sr(a). Su marcador se ha registrado con exito: "+$scope.NomEquipo1+" "+$scope.p1+" VS "+$scope.NomEquipo2+" "+$scope.p2+" Gracias por utilizar nuestra plataforma. GENESIS"  
        }
      }).then(function(response){

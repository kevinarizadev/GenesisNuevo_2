        ...
        $scope.cedulaLogin = sessionStorage.getItem('cedula');
          ...
          $scope.confirmar_aportante = function () {
            ...
            $.getJSON("php/obtenersession.php").done(function (respuesta) {
                ...
                ($scope.sesdata.cedula==1045747968)|| ($scope.sesdata.cedula==1045724924)|| ($scope.sesdata.cedula==72215168) ||($scope.sesdata.cedula==1143132399)||($scope.sesdata.cedula == 22655600) ||($scope.sesdata.cedula == 1046872440) || ($scope.sesdata.cedula == 55300012)  || ($scope.sesdata.cedula == 1045723407) || ($scope.sesdata.cedula == 32886271) || ($scope.sesdata.cedula == 1001914688) || ($scope.sesdata.cedula==73548240)||($scope.sesdata.cedula == 37899633)||($scope.sesdata.cedula==1143163517) || ($scope.sesdata.cedula==1140889298) || ($scope.sesdata.cedula==1067934782)||  ($scope.sesdata.cedula==1065616520)){
                    $scope.editar_novedad='S';
                }else{
                    $scope.editar_novedad='N';
                }
                if ($scope.sesdata.cedula == 1045747968 || ($scope.sesdata.cedula==1045724924)|| ($scope.sesdata.cedula==72215168) ||$scope.sesdata.cedula==63325247|| $scope.sesdata.cedula == 1001914688 ||$scope.sesdata.cedula == 1143132399 || $scope.sesdata.cedula == 1044392371 || $scope.sesdata.cedula == 22655600  ||($scope.sesdata.cedula == 1046872440) || ($scope.sesdata.cedula == 55300012)  || ($scope.sesdata.cedula == 1045723407) || ($scope.sesdata.cedula == 32886271) || ($scope.sesdata.cedula == 1001914688) || ($scope.sesdata.cedula==73548240)|| $scope.sesdata.cedula == 37899633 || $scope.sesdata.cedula == 1044393935 ||  $scope.sesdata.cedula==1065616520) {
            ...
            $scope.llenarform = function (objeto) {
                ...
                if (objeto.codigo_estado_registro == 'A' && (($scope.sesdata.cedula  ==1143450658) ||
                    ($scope.sesdata.cedula  ==22655600) || ($scope.sesdata.cedula==37899633) || ($scope.sesdata.cedula==1045747968)||($scope.sesdata.cedula==1045724924)||($scope.sesdata.cedula==1045724924)|| ($scope.sesdata.cedula==72215168)  ||  ($scope.sesdata.cedula == 1001914688)||
               ...
               // if ( objeto.codigo_estado_registro == 'A' && ($scope.sesdata.cedula  ==22655600) || ($scope.sesdata.cedula==1143450658) || ($scope.sesdata.cedula==1045747968)|| ($scope.sesdata.cedula==72215168)  || ($scope.sesdata.cedula==37899633) ) {
                ...
                if($scope.infoempresa.codigo_estado_registro=='A' && ($scope.sesdata.cedula==1065616520 || $scope.sesdata.cedula==37899633 || $scope.sesdata.cedula==22655600 || $scope.sesdata.cedula == 1001914688 || $scope.sesdata.cedula==1045747968 || ($scope.sesdata.cedula==1045724924)||($scope.sesdata.cedula==72215168) || $scope.sesdata.cedula ==  1001914688 || $scope.sesdata.cedula==1143163517 || $scope.sesdata.cedula==1143132399 )){

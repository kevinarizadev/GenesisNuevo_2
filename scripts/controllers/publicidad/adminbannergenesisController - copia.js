  ...
  .controller('adminbannergenesisController', ['$scope', '$http',
    function ($scope, $http) {
      ...
      $scope.listarImagenesActuales = function () {
        ...
        $http({
          method: 'POST',
          url: "php/publicidad/adminbannergenesis.php",
          data: {
          ...
          if (result) {
            ...
            setTimeout(() => {
              ...
              for (var i = 0; i < images.length; i++) {
                ...
                const x = $scope.getRandomArbitrary(1,10000).toFixed(0) + i;
                $http({
                  method: 'POST',
                  url: "php/publicidad/adminbannergenesis.php",
                  data: {
                    ...
                    nombre: "image_" + x + "." + images[i].src.split(".")[(images[i].src.split(".").length) - 1]
                  }
                }).then(function ({ data }) {

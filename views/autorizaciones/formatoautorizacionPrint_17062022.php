              ...
              <div class="col s2">
                <div id="qrcode" style="float:right"></div>
						...
						<div class="col s12" style="padding-left: 2px;">
							...
							<div class="col s6">
<span ng-if="datosAU.DatosBasico[0].mipres =='' || datosAU.DatosBasico[0].mipres =='0'">Autorizado por: {{datosAU.DatosBasico[0].autpor}}</span>
							
<span ng-if="datosAU.DatosBasico[0].mipres !='' || datosAU.DatosBasico[0].mipres !='0'">Medico Tratante:{{datosAU.DatosBasico[0].nombre_medico}}</span>

...
<body id="ele4" ng-controller="formatautorizacionController" ng-class="{'prioridad': datosAU.DatosBasico[0].prioridad=='S' && datosAU.DatosBasico[0].clasificacion=='1001', 'prioridadnormal': datosAU.DatosBasico[0].altocosto=='S' || datosAU.DatosBasico[0].discapacidad=='D' && datosAU.DatosBasico[0].clasificacion!='1001',  'anticipo': datosAU.DatosBasico[0].anticipo=='S'}">
  <div class="row">
        ...
        <div class="col s12 headers" id="cabe" style="position: fixed; background-color: white; z-index: 999;">
          ...
          <div class="col s12" id="beneficiario" style="padding-top: 20px;">
            <fieldset style="height: 138.5px;">
              ...
              <table style="position: fixed !important; top: 115px !important; left: 53px;">
                <tbody>
                  <tr>
              ...
              <table style="position: fixed !important; top: 135px !important; left: 53px;">
                <tbody>
                  <tr>
                    <td>Identificacion: <span class="col1ben"><strong>{{datosAU.DatosBasico[0].idenb}}</strong></span>
                    </td>
                    <td style="position: fixed !important; left: 379px !important;">Sexo: <span style="position: fixed; top: 150px; left: 505px;"><strong>{{datosAU.DatosBasico[0].sexob}}</strong></span>
                    </td>
              ...
              <table style="position: fixed !important; top: 155px !important; left: 53px;">
                <tbody>
                  <tr>
              ...
              <table style="position: fixed !important; top: 175px !important; left: 53px;">
                <tbody>
                  <tr>
              ...
              <table style="position: fixed !important; top: 195px !important; left: 53px;">
                <tbody>
                  <tr>

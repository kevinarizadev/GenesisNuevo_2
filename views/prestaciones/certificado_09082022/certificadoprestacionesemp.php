...
margin-left:-35.45pt;margin-bottom:.0001pt;text-align:justify;text-indent:35.45pt'><span style='font-size:8.0pt;line-height:107%;font-family:"Arial",sans-serif'>&nbsp;</span></p>
		...
		<div style='font-size:14.2pt;font-family:"Arial";text-align: center;justify-content: center;display:flex'>
			<div style="text-align: justify;">Que, luego de revisar en nuestro sistema de información, encontramos que la empresa
            <strong>{{nombreempresa2}}</strong>, identificada con <strong> {{tipo_documento_empresa}} - {{nit2}}</strong> no registra radicación de incapacidades 

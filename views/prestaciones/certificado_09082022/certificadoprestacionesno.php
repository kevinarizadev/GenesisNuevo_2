...
<title>Certificado - Prestaciones Economicas no incapacidades</title>
...
margin-left:-35.45pt;margin-bottom:.0001pt;text-align:justify;text-indent:35.45pt'><span style='font-size:8.0pt;line-height:107%;font-family:"Arial",sans-serif'>&nbsp;</span></p>
		...
		<div style='font-size:14.0pt;font-family:"Arial";text-align: center;justify-content: center;'>
		...
		<div style='font-size:14.2pt;font-family:"Arial";text-align: center;justify-content: center;display:flex'>
			<div style="text-align: justify;">Que, luego de revisar en nuestro sistema de información, encontramos que el afiliado(a)
            <strong>{{nombreempresa}}</strong>, identificado(a) con <strong> {{tipo_afiliado}} - {{doc_afiliado}}</strong> no registra expedición de incapacidades 
		...
		<div>
			...
			<img src="./FirmaLuis.jpg" alt="" style="height: 82px;width: 144px;margin: 0;">
			...
			<p class=MsoNoSpacing><b><span style='font-size:14.0pt;font-family:"Arial",sans-serif'> <strong>COORDINADOR NACIONAL DE PRESTACIONES ECONOMICAS</strong></span></b></p>

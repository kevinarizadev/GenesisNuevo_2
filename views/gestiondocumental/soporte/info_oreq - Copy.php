...
<body ng-controller="ControladorIMP" ng-init="Hoja='OREQ'">
    ...
    <table id="table3" width="100%">
        ...
        <tr>
            ...
            <td style="text-align: left;font-family: 'Open Sans', sans-serif;">
                <!-- <span style="font-size: 13px;padding-left:5px;padding-right:25px;font-weight: 600;">Página: 1 de 1</span> -->
            </td>
        </tr>
    </table>
    ...
    <table id="table6" width="100%" style="font-family: 'Open Sans', sans-serif;margin-top:10px">
        <tbody>
            <tr>
                <!-- <td style="">1405</td> -->
                <!-- <td style="">RECEPCION EN FORMICA 3,40MTS CON PUESTO DE TRABAJO</td> -->
                <!-- <td style="">0 INDEFINIDO</td> -->
                <!-- <td style="">CJA</td> -->
        ...
        <tbody>
            ...
            <!-- <tr style="margin-top:90px;">
                <td style="text-align:left;margin-top:20px;">
                    <span style="padding-right: 15px;">Fecha y Hora de Impresión: {{FechayHora}} </span>Impreso por:
                    <span style="font-weight:600;padding-right: 15px;">{{Cedula}}</span> Estado: <span style="font-weight:600;">{{Oreq_Estado}}</span></td>
                <td style="text-align:center;"></td>
            </tr> -->
        </tbody>
    </table>

...
<table cellspacing="0" cellpadding="0" border="1" align="center">
    ...
    while (($row = oci_fetch_array($curs, OCI_ASSOC + OCI_RETURN_NULLS)) != false) {
        ...
        echo "<td>";echo $row['DEPARTAMENTO_AFILIADO'];echo "</td>";
        ...
        echo "<td>";echo $row['AFIC_SEXO'];echo "</td>";
        echo "<td>";echo $row['FECHA_NACIMIENTO'];echo "</td>";
        echo "<td>";echo $row['AFIF_AFILIACION'];echo "</td>";
        echo "<td>";echo $row['AFIC_DESCRIPCION'];echo "</td>";
        echo "<td>";echo $row['FECHA_NOVEDAD'];echo "</td>";
        echo "<td>";echo $row['AFIC_DIRECCION'];echo "</td>";
        echo "<td>";echo $row['CODIGO_DANE'];echo "</td>";
        echo "<td>";echo $row['MUNICIPIO_AFILIADO'];echo "</td>";
        echo "<td>";echo $row['AFIC_LOCALIDAD'];echo "</td>";
        echo "<td>";echo $row['AFIC_CELULAR'];echo "</td>";
        echo "<td>";echo $row['AFIC_TELEFONO'];echo "</td>";
        echo "<td>";echo $row['DESC_REGIMEN'];echo "</td>";
        echo "<td>";echo $row['DESC_CONCEPTO'];echo "</td>";
        echo "<td>";echo $row['CLAC_DESCRIPCION'];echo "</td>";
        echo "<td>";echo $row['COD_DIAGNOSTICO'] . ' - ' .$row['DESC_DIAGNOSTICO'];echo "</td>";
        echo "<td>";echo $row['FECHA_CONFIRMACION_DIAGNO'];echo "</td>";
        echo "<td>";echo $row['EGPC_ORIGEN'];echo "</td>";
        echo "<td>";echo $row['FECHA_INICIO'];echo "</td>";
        echo "<td>";echo $row['FECHA_INICIO_GESTION'];echo "</td>";
        echo "<td>";echo $row['ESTADO_GESTION'];echo "</td>";
        echo "<td>";echo $row['FECHA_GESTION'];echo "</td>";
        // echo "<td>";echo $row['OBSERVACION'];echo "</td>";
        echo "<td>";echo $row['PLURIPATOLOGICO'];echo "</td>";
        echo "<td>";echo $row['PRIORIDAD'];echo "</td>";
        // echo "<td>";echo $row['RESPONSABLE_GESTION']. ' - '.$row['NOMBRE_RESPONSABLE'];echo "</td>";
        echo "<td>";echo $row['NIT_IPS']. ' - '.$row['NOM_IPS'];echo "</td>";
        echo "<td>";echo $row['IPS_TTO'];echo "</td>";
        echo "<td>";echo $row['TIPO_TTO'];echo "</td>";
        echo "<td>";echo $row['FECHA_IPS_TTO'];echo "</td>";
        echo "<td>";echo $row['IPS_ATENCION_INTEGRAL'];echo "</td>";
        echo "<td>";echo $row['FECHA_IPS_ATENCION'];echo "</td>";
        echo "<td>";echo $row['COD_IPS_HABILITACION'];echo "</td>";
        
        echo "<td>";echo $row['RESPONSABLE_SECCIONAL'];echo "</td>";
        echo "<td>";echo $row['FECHA_GESTION_SECCIONAL'];echo "</td>";
        echo "<td>";echo $row['OBSERVACION_SECCIONAL'];echo "</td>";
        echo "<td>";echo $row['RESPONSABLE_NACIONAL'];echo "</td>";
        echo "<td>";echo $row['FECHA_GESTION_NACIONAL'];echo "</td>";
        echo "<td>";echo $row['OBSERVACION_NACIONAL'];echo "</td>";
